...
public class ChoiceDialog extends NDialog {
    ...
    public ChoiceDialog(Context context, boolean isIos) {
        ...
        if (isIos) {
            dialogWidth = (int) (screenWith - SouthUtil.dp2px(30));
    ...
    protected void setDialogDetails(Context context, final AlertDialog alertDialog) {
        ...
        if (!TextUtils.isEmpty(title)) {
            ...
            titleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, SouthUtil.sp2px( titleSize));
            titleView.setTextColor(titleColor);
            titleView.setMaxLines(titleMaxLines);
            titleView.setEllipsize(TextUtils.TruncateAt.END);
            titleView.setGravity(titleGravity);
            titleView.setPadding((int) SouthUtil.dp2px( titlePaddingTop), (int) SouthUtil.dp2px( titlePaddingLeft), (int) SouthUtil.dp2px( titlePaddingRight), (int) SouthUtil.dp2px( titlePaddingBottom));
        ...
        itemParent.setDividerPadding((int) SouthUtil.dp2px(itemDividerPadding));
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            itemParent.addView(textView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) SouthUtil.dp2px( itemHeight)));
        }
...
//                setDialogBgColor(Color.TRANSPARENT);
                setDialogBgColor(Color.parseColor("#00000000"));
            } else {
                ...
                layoutParams.setMargins((int) SouthUtil.dp2px( itemDividerPadding), 0, (int) SouthUtil.dp2px( itemDividerPadding), 0);
            ...
            allParentView.addView(textView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) SouthUtil.dp2px(itemHeight)));
        }
    ...
    private TextView getItemTextView(Typeface typeface) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, SouthUtil.sp2px( itemTextSize));
        textView.setTextColor(itemTextColor);
        textView.setMaxLines(1);
        textView.setEllipsize(TextUtils.TruncateAt.END);
        textView.setGravity(itemTextGravity);
        textView.setPadding((int) SouthUtil.dp2px(itemTextPaddingLeft), 0, (int) SouthUtil.dp2px( itemTextPaddingRight), 0);
