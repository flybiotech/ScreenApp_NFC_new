...
/**
 * 自定义imageView控件，使其可以随着手势进行放大
 * Created by 用户 on 2017/4/5.
 */

public class ZoomImageView extends android.support.v7.widget.AppCompatImageView implements Observer {
    /**
...
//                        Toast.makeText(getContext(), "请使用两根手指放大或缩小图片", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
