...
//                    w820.append(tempString).append("\n");
                    ...
                    sw300.append(start).append((int) Math.round(num * 0.6)).append(end).append("\n");
                    sw360.append(start).append((int) Math.round(num * 0.7)).append(end).append("\n");
                    sw480.append(start).append((int) Math.round(num * 0.8)).append(end).append("\n");
                    sw600.append(tempString).append("\n");
                    sw720.append(start).append((int) Math.round(num * 1.2)).append(end).append("\n");
                    sw800.append(start).append((int) Math.round(num * 1.33)).append(end).append("\n");
                    w820.append(start).append((int) Math.round(num * 1.33)).append(end).append("\n");
